...
for j in range(entrada[1]):
    ...
    g.addEdgeDic(g.vertexes[aresta[0]],g.vertexes[aresta[1]],aresta[2])
'''
g.addEdgeDic(g.vertexes[0],g.vertexes[1],7)
g.addEdgeDic(g.vertexes[0],g.vertexes[4],5)
g.addEdgeDic(g.vertexes[1],g.vertexes[4],9)
g.addEdgeDic(g.vertexes[1],g.vertexes[3],8)
g.addEdgeDic(g.vertexes[1],g.vertexes[5],7)
g.addEdgeDic(g.vertexes[3],g.vertexes[5],5)
g.addEdgeDic(g.vertexes[4],g.vertexes[5],15)
g.addEdgeDic(g.vertexes[4],g.vertexes[6],6)
g.addEdgeDic(g.vertexes[5],g.vertexes[6],8)
g.addEdgeDic(g.vertexes[5],g.vertexes[7],9)
g.addEdgeDic(g.vertexes[6],g.vertexes[7],11)
